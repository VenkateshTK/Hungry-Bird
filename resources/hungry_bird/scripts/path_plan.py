...
class Edrone():
	...
	def altitude_set_pid(self,alt):
		...
		self.Kd[2] = alt.Kd * 0.05

	#----------------------------Define callback function like altitide_set_pid to tune pitch, roll and yaw as well--------------
	def pitch_set_pid(self,alt):
		self.Kp[0] = alt.Kp * 0.05
		self.Ki[0] = alt.Ki * 0.05
		self.Kd[0] = alt.Kd * 0.05

	def roll_set_pid(self,alt):
		self.Kp[1] = alt.Kp * 0.05
		self.Ki[1] = alt.Ki * 0.05
		self.Kd[1] = alt.Kd * 0.05

	def yaw_set_pid(self,alt):
		self.Kp[3] = alt.Kp * 0.05
		self.Ki[3] = alt.Ki * 0.05
		self.Kd[3] = alt.Kd * 0.05
