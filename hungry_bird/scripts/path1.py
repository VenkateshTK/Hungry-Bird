...
class Edrone():
	...
	def whycon_callback(self,msg):
		...
		#--------------------Set the waypoints of the drone from msg----------------------------------------------
	...
	# This function sets the pid values
	def set_value(self):
		self.Kp[2] = 0.6*288 * 0.06 
		self.Ki[2] = 0 * 0.008
		self.Kd[2] = 1015 * 0.3
	...
	#	8. Add error_sum
		...
		if self.mode == 0:
			...
			self.cmd.rcPitch = 1500-0.5*self.out[0] 
			self.cmd.rcRoll = 1500-0.5*self.out[1]
			self.cmd.rcYaw=1500
		...
		#------------------------------------------------------------------------------------------------------------------------
			...
			if self.error[0] < 0.5 and self.error[0] > -0.5 and self.error[1] < 0.5 and self.error[1] > -0.5 and self.error[2] > -0.5 and self.error[2] < 0.5:
				self.mode = 1
				self.j = 0
				self.vrep_msg.publish('1')
